...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-blue-600 text-white p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                <a href="faq.php" class="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50">View FAQs</a>
                            ...
                            <div id="form-<?php echo $id; ?>" class="hidden mt-3">
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="answer" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg" required></textarea>
                                    </div>
